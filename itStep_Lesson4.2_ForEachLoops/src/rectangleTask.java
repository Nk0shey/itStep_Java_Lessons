/*
Завдання 3: Користувач вводить з клавіатури довжину та ширину прямокутника.
...
public class rectangleTask {
    public static void main(String[] args) {
        ...
        System.out.print("[row]012");
        System.out.println("");

        for(int row = 0; row < rowNumbers; row++) { // Rows
            System.out.print("[" + row + "]");

            for(int column = 0; column < columnNumbers; column++) { // Rows
//                System.out.print("[" + column + "]");
                if(row == 0 || column == 0 || row == rowNumbers - 1 || column == columnNumbers - 1) {
                    System.out.print("#");
                } else {
                    System.out.print(" ");
                }
